...
dataset = pd.read_csv("../input/sep-dataset-5/20161231_20190213_v1.csv",infer_datetime_format=True,
                      parse_dates = ['DATA'])  
...
hldys1 = pd.DataFrame({
  ...
  'ds': pd.to_datetime([
                        ...
                        '2018-09-07', '2018-10-12', '2018-11-02', '2018-11-15','2019-03-05','2019-04-19',
...
hldys4 = pd.DataFrame({
  'holiday': 'alta',
  'ds': pd.to_datetime(['2017-05-13', '2017-06-10', '2017-08-12', '2017-11-24', 
                        '2018-05-12', '2018-06-12', '2018-08-11', '2018-11-23',
                        '2019-05-11','2019-06-12','2019-08-10','2019-11-22']),
  'lower_window': 0,
  'upper_window': 0,
})
...
b = dataset.set_index('DATA')['2019-02-01':'2019-02-12']['TRN_TOTAL'].sum()
c = a['2019-02-13':'2019-02-17']['yhat'].sum()
est = b + c
est
'''
